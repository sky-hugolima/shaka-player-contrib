...
shaka.util.Platform = class {
   ...
   */
  static isApple() {
    return shaka.util.Platform.isMac() || shaka.util.Platform.isAppleMobile();
  ...
  static isAppleMobile() {
    ...
    // detection.
    return shaka.util.Platform.isMac() && navigator.maxTouchPoints > 1;
  }
   ...
   */
  static isMobile() {
    return shaka.util.Platform.isAndroid() ||
        shaka.util.Platform.isAppleMobile();
  }
